                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-xl-6 col-sm-12 col-12">
                                    <input type="text" class="User-Name" id="UserName" name="UserName" placeholder="Username or email" style="padding-left:10px;" onkeydown="moveToNextField(event, 'password')">
                                </div>
                                <div class="col-lg-3 col-md-3 col-xl-3 col-sm-0 col-0">
...
if (!empty($Email) && !empty($Password)) {
    ...
    if ($result) {
        ...
        if ($user && password_verify($Password, $user['password'])) {
            ...
            // Đăng nhập thành công, tiếp tục xử lý

            // Chuyển hướng người dùng đến trang user_page.php
            header('Location: user_page.php');
            exit; // Đảm bảo kết thúc tất cả các hoạt động sau khi chuyển hướng
        } else {
            echo "<script>alert('Email hoặc mật khẩu không đúng!');</script>";
        }
    } else {
        echo "<script>alert('Đã xảy ra lỗi trong quá trình đăng nhập!');</script>";
    }
} else {
    echo "<script>alert('Hãy điền đầy đủ thông tin đăng nhập!');</script>";
}
