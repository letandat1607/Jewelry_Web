  ...
  if(!empty(trim($filterAll['email'])) && !empty(trim($filterAll['password']))){
    ...
    if(!empty($adminQuery)){
      ...
      if($passwordAdmin == $password){
        $tokenLoginAdmin = sha1(uniqid().time());
...
<head>
  ...
  <link rel="stylesheet" href="templates/CSS/login_admin.css?v= <?php echo time(); ?>">
...
<div class="container-fluid">
  ...
  <section class="content">
    <div class="container">
        <div class="log-in">
            <p><b>Đăng nhập</b></p>
            <div class="icon-admin"><ion-icon name="person-circle-outline"></ion-icon></div>
            <?php
                if(!empty($smg)){
                    getSmg($smg, $smg_type);
                }
    ...
    <div class="container">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="footer-content">
                <div class="row">
                    <div class="col-lg-6 col-xl-6 col-md-12 col-xs-12 content-info info1">
                        <h5>RANVERBAE BRAND - RVB</h5>
                        <br>
                        <p>Admin1: Lê Tấn Đạt-3122411038</p>
                        <p>Admin2: Trương Quốc Bảo-3122411016</p>
                        <p>Admin3: Trần Gia Phúc-3122411158</p>
                        <p>Admin4: Trần Thiện Tâm-3122411179</p>
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-12 col-xs-12 content-info info2">
                        <h5>WORKTIME :</h5>
                        <br>
                        <p>MONDAY– SUNDAY:</p>
                ...
                <div class="row last-info">
                    <p class="content-info">
                        <a href="">SEARCH</a> | <a href="">ABOUT</a> | <a href="">RETURN POLICY</a> | <a href="">PRIVACY POLICY</a> | <a href="">TERMS OF SERVICE</a>
                    </p>
                </div>
            </div>
        </div>
